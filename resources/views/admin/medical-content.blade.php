...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-8">Medical Content Management</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-gray-500 text-sm font-medium uppercase tracking-wide">Knowledge Base</h3>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-gray-500 text-sm font-medium uppercase tracking-wide">FAQs</h3>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-gray-500 text-sm font-medium uppercase tracking-wide">Templates</h3>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-gray-500 text-sm font-medium uppercase tracking-wide">Chat Logs</h3>
                ...
                @forelse($content['knowledge_base'] as $article)
                    <div class="p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition duration-150">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex flex-wrap gap-2">
                                    @if(isset($article['tags']) && is_array($article['tags']) && count($article['tags']) > 0)
                                        ...
                                        @endforeach
                                    @else
                                        <span class="px-2 py-1 bg-gray-100 text-gray-600 text-xs font-medium rounded-full">No tags</span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="mt-3 flex justify-end space-x-2">
                            <a href="{{ route('admin.medical-content.knowledge-base.edit', $article['id']) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Edit</a>
                            <button onclick="showDeleteConfirm('knowledge-base', {{ $article['id'] }}, 'Are you sure you want to delete this article? This action cannot be undone.')" class="text-red-600 hover:text-red-800 text-sm font-medium">Delete</button>
                    ...
                    <div class="p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition duration-150">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">{{ $faq['category'] ?? 'General' }}</p>
                            </div>
                            <span class="px-2 py-1 text-xs font-medium rounded-full
                        ...
                        <div class="mt-3 flex justify-end space-x-2">
                            <a href="{{ route('admin.medical-content.faq.edit', $faq['id']) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Edit</a>
                            <button onclick="showDeleteConfirm('faq', {{ $faq['id'] }}, 'Are you sure you want to delete this FAQ? This action cannot be undone.')" class="text-red-600 hover:text-red-800 text-sm font-medium">Delete</button>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 mt-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-semibold text-gray-800">Consultation Templates</h2>
            <button class="text-blue-600 hover:text-blue-800 font-medium text-sm flex items-center">
                View All
                <svg class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($content['templates'] as $template)
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $template['specialty'] ?? 'General Medicine' }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-2">
                                <a href="{{ route('admin.medical-content.template.edit', $template['id']) }}" class="text-blue-600 hover:text-blue-900" title="Edit Template">
                                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </a>
                                <button onclick="showDeleteConfirm('template', {{ $template['id'] }}, 'Are you sure you want to delete this template? This action cannot be undone.')" class="text-red-600 hover:text-red-900" title="Delete Template">
                                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
