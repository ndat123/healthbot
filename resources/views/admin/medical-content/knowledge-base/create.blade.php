...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Add New Knowledge Base Article</h1>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
        <form action="{{ route('admin.medical-content.knowledge-base.store') }}" method="POST" class="space-y-6">
            @csrf
