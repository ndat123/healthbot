...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Edit Template</h1>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
        <form action="{{ route('admin.medical-content.template.update', $template->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <textarea id="content" 
                          ...
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('content') border-red-500 @enderror">{{ old('content', $template->content) }}</textarea>
                @error('content')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="specialty" 
                           name="specialty" 
                           value="{{ old('specialty', $template->specialty) }}" 
                ...
                <div>
                    ...
                    <select id="status" 
                        ...
                        <option value="published" {{ old('status', $template->status) == 'published' ? 'selected' : '' }}>Published (Active)</option>
