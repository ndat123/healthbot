...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Add New Training Scenario</h1>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
        <form action="{{ route('admin.ai-management.scenarios.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('name') }}" 
                       required
                       placeholder="e.g., Emergency situation, General consultation"
            ...
            <div>
                ...
                <select id="status" 
                    ...
                    <option value="trained" {{ old('status') == 'trained' ? 'selected' : '' }}>Trained</option>
